<footer>
    <div class="footer-top">
        ...
        <div class="footer-section footer-contatos">
            ...
            <div class="contatos">
                <div class="div-contato endereco">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="25" fill="white" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                    </svg>
                    <div class="footer-texto">
                        <h4>Endereço</h4>
                        <p>Rua Américo Scaranello, Wilson Bernardi, Sertãozinho-SP</p>
                    </div>
                </div>
                <div class="div-contato telefone">
