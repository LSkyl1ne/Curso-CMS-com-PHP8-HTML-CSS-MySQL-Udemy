        ...
        <div class="header">
            <div class="header-top">
                ...
                <div class="contact-top">
                    <div class="smartphone-top">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="white" class="bi bi-phone" viewBox="0 0 16 16">
                    ...
                    <div class="email-top">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="white" class="bi bi-envelope" viewBox="0 0 16 16">
            ...
            <div class="header-bottom">
                <div class="bar">
                    ...
                    <div class="bar-button active"></div>
                    <div class="bar-button active"></div>
                    <div class="bar-button active"></div>
                </div>
                <div class="menu">
